...
public:
    ...
    const std::unique_ptr< const bool > forceEncryptedClientConnections = nullptr;   //! True, if the 'ellClientManager' shall only accept encrypted connection attempts from the clients
